...
<%@ page import="com.manydesigns.portofino.custom.DbUtils4AppBase" %>
...
<jsp:useBean id="actionBean" scope="request"
             type="com.manydesigns.portofino.pageactions.chart.jfreechart.JFreeChartAction4AppBase"/>
<stripes:layout-render name="/theme/templates/${actionBean.pageInstance.layout.template}/modal.jsp">
    ...
    <stripes:layout-component name="pageBody">
        <%
            ...
            String dbName = actionBean.getChartConfiguration().getDatabase();
            List<Map<String, Object>> mapList = DbUtils4AppBase.runSqlReturnMap(dbName, sql, request);
            List<String> columns = DbUtils4AppBase.getColumnName(mapList, sql);
            List<List<String>> rows = DbUtils4AppBase.getRowValues(mapList, sql);
