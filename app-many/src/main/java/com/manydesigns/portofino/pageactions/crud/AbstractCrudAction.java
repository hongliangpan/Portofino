...
public abstract class AbstractCrudAction<T> extends AbstractPageAction {
    ...
    /**
     * {@link #loadObjectByPrimaryKey(Serializable))
    ...
    @Button(list = "crud-search", key = "create.new", order = 0, type = Button.TYPE_SUCCESS,
    ...
    @Buttons({
            @Button(list = "crud-search", key = "edit", order = 2, icon = Button.ICON_EDIT, type = Button.TYPE_PRIMARY),
            @Button(list = "crud-bulk", key = "edit", order = 2, icon = Button.ICON_EDIT, type = Button.TYPE_PRIMARY)
    })
    ...
    @Button(list = "crud-read", key = "delete", order = 2, icon = Button.ICON_TRASH,type = Button.TYPE_DANGER)
    ...
    @Buttons({
            @Button(list = "crud-search", key = "delete", order = 3, icon = Button.ICON_TRASH,type = Button.TYPE_DANGER),
            @Button(list = "crud-bulk", key = "delete", order = 3, icon = Button.ICON_TRASH,type = Button.TYPE_DANGER)
    })
    @Guard(test = "isBulkOperationsEnabled()", type = GuardType.VISIBLE)
    @RequiresPermissions(permissions = PERMISSION_DELETE)
    ...
    protected Resolution getEditView() {
        if(isPopup()) {
            return new ForwardResolution("/m/crud/popup/edit.jsp");
        } else {
    ...
    protected void setupPropertyEdits() {
        ...
        for (int i = 0; i < propertyAccessors.length; i++) {
            ...
            Label labelAnn =
                    propertyAccessor.getAnnotation(Label.class);
