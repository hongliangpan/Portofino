...
import com.manydesigns.portofino.pageactions.crud.CrudAction4NewPage;
import com.manydesigns.portofino.pageactions.crud.CrudAction4SqlQuery;
import com.manydesigns.portofino.pageactions.crud.CrudAction4View;
...
public class CrudModule implements Module {
    ...
    public void init() {
        ...
        pageActionRegistry.register(CrudAction4NewPage.class);
        pageActionRegistry.register(CrudAction4View.class);
        pageActionRegistry.register(CrudAction4SqlQuery.class);
