...
class CalendarPage extends CalendarAction {
    ...
    def calDefs = [["ad config", "point.demo.ad_config", ["c_start_time", "c_end_time", "c_modify_time"], new java.awt.Color(255, 0, 0)], ["many dept", "point.demo.many_dept", ["c_create_time", "c_modify_time"], new java.awt.Color(64, 128, 255)], ["many group", "point.demo.many_group", ["c_create_time", "c_modify_time"], new java.awt.Color(0, 178, 178)], ["many group region rel", "point.demo.many_group_region_rel", ["c_create_time", "c_modify_time"], new java.awt.Color(128, 128, 128)], ["many user", "point.demo.many_user", ["c_create_time", "c_modify_time"], new java.awt.Color(0, 178, 0)], ["用户所属共组", "point.demo.many_user_group_rel", ["c_create_time", "c_modify_time"], new java.awt.Color(255, 200, 0)], ["sys product", "point.demo.sys_product", ["c_modify_time"], new java.awt.Color(178, 178, 0)], ["sys province", "point.demo.sys_province", ["modify_time"], new java.awt.Color(178, 0, 178)], ["sys region", "point.demo.sys_region", ["c_create_time", "c_modify_time"], new java.awt.Color(255, 175, 175)]]; //Es. [["Cal 1", "db1.schema1.table1", ["column1", "column2"], Color.RED], ["Cal 2", "db1.schema1.table2", ["column1", "column2"], Color.BLUE]]
