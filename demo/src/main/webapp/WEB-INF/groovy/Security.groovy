...
public class Security extends AbstractPortofinoRealm {
    ...
    protected String databaseName = "point";

    protected String userTableEntityName = "many_user";
    protected String userIdProperty = "c_id";
    protected String userNameProperty = "c_name";
    protected String userEmailProperty = "c_email";
    protected String userTokenProperty = "c_token";
    protected String passwordProperty = "c_password";

    protected String groupTableEntityName = "many_group";
    protected String groupIdProperty = "c_id";
    protected String groupNameProperty = "c_name";

    protected String userGroupTableEntityName = "many_user_group_rel";
    protected String groupLinkProperty = "c_group_id";
    protected String userLinkProperty = "c_user_id";

    protected String adminGroupName = "super";

    ////Password Hashing
    protected int hashIterations = 1;
    protected String hashAlgorithm = "MD5";
    protected HashFormat hashFormat = new org.apache.shiro.crypto.hash.format.Base64Format();
    ...
    protected Collection<String> loadAuthorizationInfo(Serializable principal) {
        ...
        if(StringUtils.isEmpty(userGroupTableEntityName) || StringUtils.isEmpty(groupTableEntityName)) {
            ...
            def queryString = """
                select distinct g.c_name
                from many_group g, many_user_group_rel ug, many_user u
                where g.c_id = ug.c_group_id
                and ug.c_user_id = u.c_id
                and u.c_id = :userId
            """;
    ...
    Map<Serializable, String> getUsers() {
        ...
        Query query = session.createQuery(
                "select c_id, c_name from many_user order by c_name");
