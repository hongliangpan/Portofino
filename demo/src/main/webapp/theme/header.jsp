...
%>
<%@ page import="com.manydesigns.portofino.utils.ContextUtils" %>
...
<header class="navbar  navbar-static-top" role="banner">
    <div class="container">
        ...
        <div class="container" style="margin-top:8px;">
            ...
            <div class="pull-left menuStyle" >
                <stripes:link href="/ad?navigation.startingLevel=1">
                    <c:out value='广告管理'/>
                </stripes:link>
            </div>

            <div class="pull-left menuStyle"  >
                <stripes:link href="/uba?navigation.startingLevel=1">
                    <c:out value='行为分析'/>
                </stripes:link>
            </div>
            ...
            <%--<div class="pull-left" style="margin-left:18px;">
                <stripes:link href="/user?navigation.startingLevel=1">
                    <c:out value='权限管理'/>
                </stripes:link>
            </div>--%>

            <div class="pull-left menuStyle"  >
                <stripes:link href="/tools?navigation.startingLevel=1">
                    <c:out value='常用工具'/>
                </stripes:link>
            </div>
            ...
            <div class="pull-left menuStyle">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/report/report_query">配置报表</a></li>
                        <li><a href="/report/report_query">性能报表</a></li>
                        <li><a href="/report/report_query">故障报表</a></li>
                    </ul>
                </li>
            </div>
            <div class="pull-left menuStyle"  >
                <stripes:link href="/point?navigation.startingLevel=1">
                    <c:out value='积分'/>
                </stripes:link>
            </div>
            <div class="pull-left menuStyle"  >
                <stripes:link href="/sys?navigation.startingLevel=1">
                    <c:out value='系统管理'/>
                </stripes:link>
            </div>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="javascript:portofino.enablePageActionDragAndDrop($(this), '${actionBean.context.actionPath}');">
                                <em class="glyphicon glyphicon-file"></em> 编辑布局
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="javascript:portofino.confirmDeletePage<%= jsArgs %>">
                                <em class="glyphicon glyphicon-minus"></em> 删除页面
                            </a>
                        </li>
                        <li>
                            <a href="javascript:portofino.showCopyPageDialog<%= jsArgs %>">
                                <em class="glyphicon glyphicon-file"></em> 复制页面
                            </a>
                        </li>
                        <li>
                            <a href="javascript:portofino.showMovePageDialog<%= jsArgs %>">
                                <em class="glyphicon glyphicon-share"></em> 移动页面
                            </a>
                        </li>
                        <%
                        ...
                        <li>
                            <stripes:link beanclass="com.manydesigns.portofino.actions.admin.page.PageAdminAction" event="pagePermissions">
                                <stripes:param name="originalPath" value="${actionBean.context.actionPath}"/>
                                <em class="glyphicon glyphicon-user"></em> 页面授权
                            </stripes:link>
                        </li>
                        <% }}} %>
                    </ul>
