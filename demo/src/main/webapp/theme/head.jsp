...
<link rel="stylesheet" type="text/css" href="<stripes:url value='/webjars/bootstrap/3.3.5/css/bootstrap-theme.min.css' />">
    ...
    <%--<link rel="stylesheet" type="text/css" href="<stripes:url value='/static/css/bootstrap.css' />">
    <link rel="stylesheet" type="text/css" href="<stripes:url value='/static/css/bootstrap-theme.css' />">--%>
...
<script type="text/javascript" src="<stripes:url value='/webjars/momentjs/2.10.3/min/moment-with-locales.js' />" ></script>
