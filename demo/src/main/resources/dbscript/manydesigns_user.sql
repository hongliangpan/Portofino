...
DROP TABLE IF EXISTS many_user;
CREATE TABLE many_user (
...
ALTER TABLE many_user ADD UNIQUE INDEX uq_user_name (c_name) ;
ALTER TABLE many_user ADD UNIQUE INDEX uq_user_email (c_email) ;


DROP TABLE IF EXISTS many_group;
CREATE TABLE many_group (
  c_id int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
DROP TABLE IF EXISTS many_user_group_rel;
CREATE TABLE many_user_group_rel (
  ...
  CONSTRAINT fk_sgu_group_id FOREIGN KEY (c_group_id) REFERENCES many_group (c_id) ON DELETE CASCADE,
  CONSTRAINT fk_sgu_user_id FOREIGN KEY (c_user_id) REFERENCES many_user (c_id) ON DELETE CASCADE
) ENGINE=InnoDB COMMENT='用户和分组关系表';

DROP TABLE IF EXISTS many_group_region_rel;
CREATE TABLE many_group_region_rel (
  c_group_id int(10) NOT NULL COMMENT '工作组ID',
  ...
  CONSTRAINT fk_sre_group_id FOREIGN KEY (c_group_id) REFERENCES many_group (c_id),
  CONSTRAINT fk_sre_region_id FOREIGN KEY (c_region_id) REFERENCES t_dict_region (c_id)
) ENGINE=InnoDB COMMENT='区域和分组关系表';

DROP TABLE IF EXISTS many_dept;
CREATE TABLE many_dept (
  c_id int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  ...
  PRIMARY KEY (c_id)
  -- , CONSTRAINT fk_dept_parent FOREIGN KEY (c_parent_id) REFERENCES many_dept (c_id)
) ENGINE=InnoDB COMMENT='部门';

insert  into `many_dept`(`c_id`,`c_code`,`c_name`,`c_parent_id`,`c_desc`,`c_path`,`c_level`,`c_sort_id`,`c_config`,`c_create_user`,`c_create_time`,`c_modify_user`,`c_modify_time`,`c_tag1`,`c_tag2`,`c_tag3`,`c_tag4`,`c_full_path_name`) values 
...
insert  into `many_group`(`c_id`,`c_name`,`c_display_name`,`c_region_level`,`c_desc`,`c_sort_id`,`c_role`,`c_config`,`c_create_user`,`c_create_time`,`c_modify_user`,`c_modify_time`,`c_tag1`,`c_tag2`,`c_tag3`,`c_tag4`) values 
(0,'super','超级用户',0,'开发权限',NULL,'DEVELOP',NULL,NULL,NULL,NULL,'2014-01-15 18:08:35',NULL,NULL,NULL,NULL),(1,'管理员','所有权限',NULL,'管理员，具有所有编辑权限',1,'edit.field.all',NULL,'super','2014-01-16 21:47:13','super','2014-01-16 21:47:13',NULL,NULL,NULL,NULL),(2,'可以调整','可以调整，不能删除',NULL,'可以调整，不能删除基础信息，不能修改系统字段',2,'edit.field.part',NULL,'super','2014-01-16 21:47:22','super','2014-01-16 21:47:22',NULL,NULL,NULL,NULL),(3,'只能看','只能看',NULL,'只能查看，不能修改任何信息',3,'edit.field.view',NULL,'super','2014-01-16 21:47:31','super','2014-01-16 21:47:31',NULL,NULL,NULL,NULL);

insert  into `many_user_group_rel`(`c_group_id`,`c_user_id`,`c_config`,`c_create_user`,`c_create_time`,`c_modify_user`,`c_modify_time`) values 
(0,0,NULL,NULL,NULL,NULL,'2014-01-15 15:41:35'),(0,2,NULL,NULL,NULL,NULL,'2014-01-15 15:41:35'),(1,0,NULL,NULL,NULL,NULL,'2014-01-15 18:06:34'),(1,1,NULL,NULL,NULL,NULL,'2014-01-15 18:06:29'),(2,2,NULL,NULL,NULL,NULL,'2014-01-15 18:11:42'),(3,3,NULL,NULL,NULL,NULL,'2014-01-15 18:11:56');

insert  into `many_user`(`c_id`,`c_code`,`c_name`,`c_display_name`,`c_password`,`c_dept_id`,`c_region_id`,`c_email`,`c_token`,`c_type`,`c_sex`,`c_mobile`,`c_phone`,`c_fax`,`c_address`,`c_desc`,`c_login_count`,`c_create_user`,`c_create_time`,`c_modify_user`,`c_modify_time`,`c_tag1`,`c_tag2`,`c_tag3`,`c_tag4`) values 
(0,NULL,'super','超级用户','GzIxZVzrt6H3g+3fJ9JUyg==',NULL,NULL,'ruijie_its@163.com','qx0n3melstbzyiazqbi2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2014-01-15 15:41:35',NULL,NULL,NULL,NULL),(1,NULL,'admin','管理员','ISMvKXpXpadDiUoOSoAfww==',NULL,NULL,'hongliangpan@gmail.com','6667acd1-0db6-4192-8b2d-76f91f2b94c5','','','','','','','',NULL,'super','2014-01-16 21:46:56','super','2014-01-16 21:46:56',NULL,NULL,NULL,NULL),(2,'','可以调整','可以调整',NULL,1,1,'riilriil@163.com','','','','','','','','',NULL,NULL,NULL,NULL,'2014-01-15 18:11:25',NULL,NULL,NULL,NULL),(3,'','查看','查看',NULL,1,1,'test28797575@163.com','','','','','','','','',NULL,NULL,NULL,NULL,'2014-01-15 18:11:23',NULL,NULL,NULL,NULL);
